        ...
        <div className="container max-w-[100%] max-h-[680px] bg-[#f9fafb]">
            <div className="grid grid-rows-6 grid-flow-col gap-4 justify-items-center content-center w-[100%] h-[680px]">
                ...
                <div className="row-span-2 justify-center">
                    <div className='grid grid-cols-6 gap-8 w-screen h-[200px] px-20'>
                        <div className="container col-span-2 bg-[#fee2e2] w-[100%] rounded-lg shadow-md p-3">
                            <div className='flex flex-col w-[100%] h-[100%] px-10'>
                                <div className='flex justify-start h-[100%]'>
                                    Orders waiting for the pack
                                ...
                                <div className='flex justify-end place-self-end h-[100%]'>
                                    ...
                                    >
                                        <div className='flex justify-center p-1 rounded-full bg-white w-[60px] h-[60px]'>
                                            ...
                                            <i className="fa-solid text-[#f87171] text-3xl pt-2">{orderPack.length}</i>
                                        </div>
                                    </Badge>
                        ...
                        <div className="container col-span-2 bg-[#d1fae5] w-[100%] rounded-lg shadow-md p-3">
                            <div className='flex flex-col w-[100%] h-[100%] px-10'>
                                <div className='flex justify-start h-[100%]'>
                                ...
                                <div className='flex justify-end place-self-end h-[100%]'>
                                    ...
                                    >
                                        <div className='flex justify-center p-1 rounded-full bg-white w-[60px] h-[60px]'>
                                            {/* <p className='font-semibold text-md text-white ml-2'></p> */}
                                            <i className="fa-solid text-[#f87171] text-3xl pt-2">{orderDelivery.length}</i>
                                        </div>
                                    </Badge>
                        ...
                        <div className="container col-span-2 bg-[#fef9c3] w-[100%] rounded-lg shadow-md p-3">
                            <div className='flex flex-col w-[100%] h-[100%] px-10'>
                                <div className='flex justify-start h-[100%]'>
                                    Orders Waiting for confirmed
                                ...
                                <div className='flex justify-end place-self-end h-[100%]'>
                                    ...
                                    >
                                        <div className='flex justify-center p-1 rounded-full bg-white w-[60px] h-[60px]'>
                                            {/* <p className='font-semibold text-md text-white ml-2'></p> */}
                                            <i className="fa-solid text-[#f87171] text-3xl pt-2">{orderConfirmed.length}</i>
                                        </div>
                                    </Badge>
