...
//function
import { getRequestOther, getRequestTopup } from '../../../functions/request';
            ...
            <div className="flex flex-col justify-items-center content-center w-[100%]">
                ...
                <div className="flex justify-center mt-5">
                    <div className="container col-span-6 bg-white w-[90%] min-h-[450px] h-fit rounded-lg shadow-md p-10">
                        ...
                        <div className={`grid ${selectRequest === 'Other' ? 'grid-cols-3 gap-8' : 'grid-cols-2 gap-4'} my-10 justify-items-center`}>
