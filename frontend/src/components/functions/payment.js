...
export const createPayment = async (authtoken, value) => {
    return await axios.post(process.env.REACT_APP_VERCEL_API_URL+"/api/payment-admin", value, {
        headers: {
            authtoken,
        },
    });
...
export const createPaymentSeller = async (authtoken, value) => {
    return await axios.post(process.env.REACT_APP_VERCEL_API_URL+"/api/payment-seller", value, {
        headers: {
            authtoken,
        },
    });
...
export const readPayment = async (authtoken, value) => {
    ...
    return await axios.get(process.env.REACT_APP_VERCEL_API_URL+"/api/payment/" + value.username, {
        headers: {
            authtoken,
        },
    });
...
export const updatePayment = async (authtoken, id, values) => {
    return await axios.put(process.env.REACT_APP_VERCEL_API_URL+"/api/payment/" + id, values, {
        headers: {
            authtoken,
        },
    });
...
export const updatePaymentSeller = async (authtoken, id, values) => {
    return await axios.put(process.env.REACT_APP_VERCEL_API_URL+"/api/payment-seller/" + id, values, {
        headers: {
            authtoken,
        },
    });
